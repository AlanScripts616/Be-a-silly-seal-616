...
local sellAllPrompt = workspace:WaitForChild("fishIgloo"):WaitForChild("SellFish"):WaitForChild("SellAllFish")
local sellOnePrompt = workspace:WaitForChild("fishIgloo"):WaitForChild("SellFish"):WaitForChild("SellFish")
...
local SellSet = {}
for _, n in ipairs(SellableItems) do SellSet[n] = true end
        ...
        if AutoSell then
            ...
            if count >= SellLimit then
                ...
                if hrp then
                    ...
                    -- Si falla, usar vender individual
